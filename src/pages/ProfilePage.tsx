    ...
    <div className="min-h-screen w-full bg-brand-black text-white pb-24">
      <div className="relative">
        ...
        <div className="relative flex flex-col items-center justify-center pt-10 pb-6">
          ...
          <h2 className="mt-3 text-2xl font-bold">Detective User</h2>
          <p className="mt-1 text-sm text-gray-400">Member since 2025</p>
        </div>
      </div>

      <div className="mt-2">
        <CaseRow title="My List" cases={myList} />
      </div>

      <div className="mt-6 px-4 md:px-8 space-y-3">
        {['Account', 'Notifications', 'App Settings', 'Help & Support'].map((item) => (
          <button
            key={item}
